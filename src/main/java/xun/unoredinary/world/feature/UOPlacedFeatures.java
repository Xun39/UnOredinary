...
import xun.unoredinary.world.util.OrePlacement;
...
public class UOPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, HEMOCRYLIC_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.HEMOCRYLIC_ORE_KEY),
                OrePlacement.countPlacement(82,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(360))));
        register(context, LARGE_HEMOCRYLIC_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.LARGE_HEMOCRYLIC_ORE_KEY),
                OrePlacement.chancePlacement(48,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(360))));


        register(context, CRYOSTONE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.CRYOSTONE_ORE_KEY),
                OrePlacement.countPlacement(4,
                        HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(0), VerticalAnchor.absolute(15))));
        register(context, LOWER_CRYOSTONE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.CRYOSTONE_ORE_KEY),
                OrePlacement.countPlacement(8,
                        HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-32), VerticalAnchor.aboveBottom(32))));


        register(context, LUMINITE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.LUMINITE_ORE_KEY),
                OrePlacement.countPlacement(6,
                        HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-48), VerticalAnchor.belowTop(36))));

        register(context, SOLARITE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.SOLARITE_ORE_KEY),
                OrePlacement.countPlacement(20,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-80), VerticalAnchor.absolute(0))));

        register(context, RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.SMALL_RUBY_ORE_KEY),
                OrePlacement.countPlacement(7,
                        HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
        register(context, MEDIUM_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.MEDIUM_RUBY_ORE_KEY),
                OrePlacement.countPlacement(2,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-8))));
        register(context, LARGE_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.LARGE_RUBY_ORE_KEY),
                OrePlacement.chancePlacement(11,
                        HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
        register(context, BURIED_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(UOConfiguredFeatures.SMALL_RUBY_ORE_KEY),
                OrePlacement.countPlacement(5,
                        HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
    }
