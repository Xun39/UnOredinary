...
public abstract class UORecipeProvider extends RecipeProvider {
    ...
    protected static void toolSet(RecipeOutput recipeOutput, Supplier<Item> ingredient, ToolSet set) {
        sword(recipeOutput, ingredient, set.sword());
        pickaxe(recipeOutput, ingredient, set.pickaxe());
        axe(recipeOutput, ingredient, set.axe());
        hoe(recipeOutput, ingredient, set.hoe());
        shovel(recipeOutput, ingredient, set.shovel());
    }
    ...
    protected static void armorSet(RecipeOutput recipeOutput, Supplier<Item> ingredient, ArmorSet set) {
        helmet(recipeOutput, ingredient, set.helmet());
        chestplate(recipeOutput, ingredient, set.chestplate());
        leggings(recipeOutput, ingredient, set.leggings());
        boots(recipeOutput, ingredient, set.boots());
    }
