...
public class UOGlobalLootModifiers extends GlobalLootModifierProvider {

    public UOGlobalLootModifiers(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
