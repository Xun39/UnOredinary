...
public class ModStructureTypes {
    ...
    public static final DeferredHolder<StructureType<?>, StructureType<FrozenTombStructures>> FROZEN_TOMB_STRUCTURES = STRUCTURE_TYPES.register("frozen_tomb_structures",
            () -> explicitStructureTypeTyping(FrozenTombStructures.CODEC));
