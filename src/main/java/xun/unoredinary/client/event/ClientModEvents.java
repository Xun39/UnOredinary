...
public class ClientModEvents {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        EntityRenderers.register(ModEntityTypes.FROST_ZOMBIE.get(), FrostZombieRenderer::new);
    }
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayers.FROST_ZOMBIE, () -> FrostZombieModel.createBodyLayer(CubeDeformation.NONE));
        event.registerLayerDefinition(ModModelLayers.FROST_ZOMBIE_OUTER_LAYER, () -> FrostZombieModel.createBodyLayer(new CubeDeformation(0.25F)));
        event.registerLayerDefinition(ModModelLayers.FROST_ZOMBIE_INNER_ARMOR, () -> innerArmorLayerdefinition);
        event.registerLayerDefinition(ModModelLayers.FROST_ZOMBIE_OUTER_ARMOR, () -> outerArmorLayerdefinition);
    }
}