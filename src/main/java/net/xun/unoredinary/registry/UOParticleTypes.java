...
public class UOParticleTypes {
    ...
    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> FROST_NOVA = register("frost_nova", false);
    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> TRANSENCHANT = register("transenchant", false);
