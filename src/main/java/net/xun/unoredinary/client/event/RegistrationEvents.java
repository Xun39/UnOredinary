...
import net.xun.unoredinary.client.renderer.entity.FrostRevenantRenderer;
import net.xun.unoredinary.client.renderer.entity.FrostShardRenderer;
...
import net.xun.unoredinary.client.renderer.entity.FrostZombieRenderer;
