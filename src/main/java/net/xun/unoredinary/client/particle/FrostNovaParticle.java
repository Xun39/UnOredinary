...
/// This class was modified from the Explosive Enhancement Reforged mod
public class FrostNovaParticle extends TextureSheetParticle {

    private final SpriteSet sprites;
    private static final Quaternionf QUATERNION = new Quaternionf(0F, -0.7F, 0.7F, 0F);

    protected FrostNovaParticle(ClientLevel level, double x, double y, double z, SpriteSet sprites, double xSpeed, double ySpeed, double zSpeed) {
        super(level, x, y + 0.2, z, 0.0, 0.0, 0.0);
        this.quadSize = (float) xSpeed;
        this.setParticleSpeed(0D, 0D, 0D);
        this.lifetime = (int) (15 + (Math.floor(xSpeed / 5)));
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new FrostNovaParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
