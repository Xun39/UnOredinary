...
@OnlyIn(Dist.CLIENT)
public class RimeParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected RimeParticle(
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            RimeParticle rimeParticle = new RimeParticle(
                    level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites
            );
            rimeParticle.setColor(0.923F, 0.964F, 0.999F);
            return rimeParticle;
        }
    }
}
